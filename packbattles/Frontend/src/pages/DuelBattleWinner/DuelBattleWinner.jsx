...
import "./DuelBattleWinner.css"
import BattleCard from '../../components/BattleCard/BattleCard'
const DuelBattleWinner = () => {
    return (
        <>
            <div className="duel-battle-winner">
                {/* BG */}
                            ...
                            <div className="col-md-4">
                                ...
                                <div className="player-card-outer mx-auto">
                                    <div className="player-card">
                                        ...
                                        <div className="player-card-pack text-center d-grid align-items-center  align-self-center">
...
export default DuelBattleWinner