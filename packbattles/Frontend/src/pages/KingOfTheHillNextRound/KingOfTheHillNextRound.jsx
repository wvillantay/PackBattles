...
import "./KingOfTheHillNextRound.css"
...
const KingOfTheHillNextRound = () => {
    return (
        <>
            {/* BATTLE POPUP */}
            <section className='battle-popup-outer king-of-the-hill-round'>
                <div className="battle-popup">
                    <h2 className='text-center'>First Round Over</h2>

                    <div className="d-flex flex-wrap flex-column flex-lg-row align-items-center justify-content-center">
                    ...
                    <div className="d-flex justify-content-center align-items-center gap-3 mt-5 winners">
                        <div className="player-card ">
                            <PlayerProfileCard avatar="./imgs/Ellipse 4 (5).png" name="Player name" isWinner={true} />
...
export default KingOfTheHillNextRound