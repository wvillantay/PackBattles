  ...
  return (
    <AuthProvider>
      ...
      <Routes>
        ...
        <Route path="/duel-battle"         element={<ProtectedRoute><DuelBattle /></ProtectedRoute>} />
        <Route path="/duel-battle-winner"  element={<ProtectedRoute><DuelBattleWinner /></ProtectedRoute>} />
